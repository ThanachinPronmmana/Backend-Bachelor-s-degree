/*
  ...
  - The values [SELL] on the enum `Sell_Rent` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Sell_Rent_new" AS ENUM ('SALE', 'RENT');
